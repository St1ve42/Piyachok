...
export class SetVarchar300AccessRefreshTokens1774632307366 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`token\` ADD \`accessToken\` varchar(300) NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`token\` DROP COLUMN \`refreshToken\``,
        );
        await queryRunner.query(
            `ALTER TABLE \`token\` ADD \`refreshToken\` varchar(300) NOT NULL`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`user\` CHANGE \`roleId\` \`roleId\` int NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`user\` CHANGE \`cityId\` \`cityId\` int NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`user\` CHANGE \`regionId\` \`regionId\` int NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`user\` CHANGE \`roleId\` \`roleId\` int NOT NULL`,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`user\` CHANGE \`regionId\` \`regionId\` int NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`user\` CHANGE \`cityId\` \`cityId\` int NULL`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`token\` ADD \`refreshToken\` varchar(255) NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`token\` DROP COLUMN \`accessToken\``,
        );
