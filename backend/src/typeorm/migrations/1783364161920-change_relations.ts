...
export class ChangeRelations1783364161920 implements MigrationInterface {
    name = 'ChangeRelations1783364161920';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `DROP INDEX \`IDX_d05c7d9db6a5a1b0c98ac56b46\` ON \`food_and_drink\``,
        );
        await queryRunner.query(
            `ALTER TABLE \`food_and_drink\` CHANGE \`email\` \`managerId\` varchar(255) NOT NULL`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`user\` ADD CONSTRAINT \`FK_b69201a1f571738e35043125ec9\` FOREIGN KEY (\`managedFoodAndDrinkId\`) REFERENCES \`food_and_drink\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_b69201a1f571738e35043125ec9\``,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE \`food_and_drink\` ADD \`managerId\` varchar(255) NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE \`food_and_drink\` CHANGE \`managerId\` \`email\` varchar(255) NOT NULL`,
        );
        await queryRunner.query(
            `CREATE UNIQUE INDEX \`IDX_d05c7d9db6a5a1b0c98ac56b46\` ON \`food_and_drink\` (\`email\`)`,
        );
        await queryRunner.query(
