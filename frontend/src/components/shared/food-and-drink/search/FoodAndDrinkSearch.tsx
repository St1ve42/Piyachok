...
import useFoodAndDrinkSearch from "@/src/components/shared/food-and-drink/search/useFoodAndDrinkSearch";
...
const FoodAndDrinkSearch: FC<PropsType> = (props) => {
    const {inputValue, pathname, router, createQueryString, foodAndDrinkResponse, isOpen, setIsOpen, handleChangeInput, handleOnKeyDownInput, handleClickClearButton, handleActionListBox} = useFoodAndDrinkSearch(props)
    return (
