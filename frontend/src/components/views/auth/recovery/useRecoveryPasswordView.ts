...
import {recoveryValidator} from "@/src/validators/auth/recovery.validator";
...
const useRecoveryPasswordView = ({token}: PropsType) => {
...
export default useRecoveryPasswordView