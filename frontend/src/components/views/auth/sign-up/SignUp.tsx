...
import useSignUp from "@/src/components/views/auth/sign-up/useSignUp";
import Image from "next/image";
import { Button, Form, Heading, Input, Label } from "@heroui/react";

const SignUp = () => {
    const {isLoading, previousApiResponse, isOpenRegion, setIsOpenRegion, isShownPassword, setIsShownPassword, isShownRepeatedPassword, setIsShownRepeatedPassword, isOpenCity, setIsOpenCity, regionId, regionInputValue, cityInputValue, errors, register, isValid, regionQuery, cityQuery, ref, handleCityInputChange, handleRegionInputChange, handleRegionSelect, handleCitySelect, regions, cities, apiErrorMessage, handleSubmit, handleFormSubmit, onFocusInput} = useSignUp()
    return (
